          ...
          <div className="flex gap-6">
            {podcast.cover_image_url ? (
              ...
              <div className="flex h-32 w-32 items-center justify-center rounded-lg bg-muted">
                <span className="text-4xl font-bold text-muted-foreground">{podcast.title[0]}</span>
              </div>
            )}
            <div className="flex-1">
              <h1 className="text-3xl font-bold">{podcast.title}</h1>
              {podcast.description && <p className="mt-2 text-muted-foreground">{podcast.description}</p>}
