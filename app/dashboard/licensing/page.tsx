                    ...
                    <div>
                        ...
                        {activeLicense ? (
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm text-muted-foreground">
                                            {activeLicense.license_type === "b2b_only"
                                                ...
                                                : "Your content is licensed for both B2B and B2C use. Generated summaries may appear on the public PODSLICE.Ai Studio platform."}
                                        </p>
                                    </div>
                            ...
                            <Card className="p-8 text-center">
                                ...
                                <p className="mt-2 text-sm text-muted-foreground">
                                    Sign a license agreement to start using PODSLICE.Ai Studio
                                </p>
                            </Card>
                        )}
                    ...
                    <Card className="p-6">
                        <div className="prose prose-sm max-w-none dark:prose-invert">
                            <p className="leading-relaxed">
                                All content generated by PODSLICE.Ai Studio includes automatic attribution to ensure
                            ...
                            <ul className="mt-3 space-y-2">
                                ...
                                <li>"Generated by PODSLICE.Ai Studio" watermark</li>
