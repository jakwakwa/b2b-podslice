      ...
      <div className="container mx-auto flex h-16 items-center justify-between px-4">
        <div className="flex items-center gap-8">
          ...
          <nav className="flex items-center gap-6">
            ...
            <Link href="/dashboard/episodes" className="text-sm font-medium hover:text-primary">
              Episodes
            </Link>
            <Link href="/dashboard/analytics" className="text-sm font-medium hover:text-primary">
              Analytics
            </Link>
            <Link href="/dashboard/royalties" className="text-sm font-medium hover:text-primary">
              Royalties
            </Link>
          </nav>
        </div>
