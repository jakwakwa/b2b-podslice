          ...
          <Card className="p-4 transition-colors hover:bg-muted/50">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                {podcast.description && (
                  <p className="mt-1 text-sm text-muted-foreground line-clamp-1">{podcast.description}</p>
                )}
                {podcast.category && (
                  <span className="mt-2 inline-block text-xs text-muted-foreground">{podcast.category}</span>
                )}
              </div>
            </div>
          </Card>
