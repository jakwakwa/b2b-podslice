...
export type ChartConfig = Record<
  ...
  {
    label?: string
    color?: string // CSS color or CSS var, e.g. "hsl(var(--chart-1))"
  }
>
...
export function ChartTooltipContent({
  ...
  return (
    <div className="rounded-md border bg-background/95 px-3 py-2 text-sm shadow-sm backdrop-blur supports-[backdrop-filter]:bg-background/60">
      {label && <div className="mb-1 font-medium text-foreground/80">{String(label)}</div>}
