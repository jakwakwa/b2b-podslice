            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  <Badge variant="secondary">{typeLabels[summary.summary_type] || summary.summary_type}</Badge>
                  <span className="text-sm text-muted-foreground">{summary.podcast_title}</span>
                </div>
                <h3 className="mt-1 font-semibold">{summary.episode_title}</h3>
                <p className="mt-1 text-sm text-muted-foreground line-clamp-1">{summary.content}</p>
