...
export function LicenseForm({
  ...
  const [licenseType, setLicenseType] = useState(currentLicense?.license_type || "b2b_only")
  const [tdmOptOut, setTdmOptOut] = useState(currentLicense?.tdm_opt_out || false)
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <RadioGroup value={licenseType} onValueChange={setLicenseType}>
            <div className="flex items-start space-x-3 rounded-lg border p-4">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Your generated content remains private to your organization. No public sharing on the Podslice
                  platform.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3 rounded-lg border p-4">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Your generated content can appear on the public Podslice platform with full attribution. Earn
                  additional royalties from public engagement.
                </p>
              </div>
            </div>
          </RadioGroup>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start space-x-3 rounded-lg border p-4">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Under EU regulations, you can opt out of having your content used for text and data mining purposes.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-start space-x-3">
          ...
          <Label htmlFor="agree" className="cursor-pointer text-sm leading-relaxed">
            I agree to the Podslice Terms of Service and understand that all generated content will include attribution
            to my original podcast episodes.
          </Label>
        </div>
        ...
        <Button type="submit" disabled={loading || !agreed} className="w-full">
          {loading ? "Processing..." : currentLicense ? "Update License" : "Sign License Agreement"}
        </Button>
      </form>
    </Card>
  )
